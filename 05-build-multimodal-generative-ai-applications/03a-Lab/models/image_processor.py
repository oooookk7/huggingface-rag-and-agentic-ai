...
class ImageProcessor:
    ...
    def __init__(self, image_size=(224, 224), 
        ...
        """
        # Ensure torchvision weights cache is writable in restricted environments.
        ...
        # Offline-safe initialization: avoid downloading weights at runtime.
        self.model = resnet50(weights=None).to(self.device)
